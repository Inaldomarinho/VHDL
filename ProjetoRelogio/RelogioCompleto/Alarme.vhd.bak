...
begin
	...
	LOGICADOALARME: LogicaAlarme port map (config, not set, SaidaC,SaidaS);
	MIN0A9 : Contador0a9 port map (saidaC and saidaS and not start, not reset, '1', Minutos1Sig, C(0));
	MIN0A5 : Contador0a5 port map (C(0), not reset, '1', Minutos2Sig);
	HR0A9 : Contador0a9 port map ((saidaC and not saidaS and not  start), SignalResetHora or not reset, '1', Horas1Sig, C(1));
   HR0A2 : Contador0a2 port map (C(1), SignalResetHora or not reset, '1', Horas2Sig);	
	...
	Ativado <= not Horas1Sig(0) and not Horas1Sig(1) and not Horas1Sig(2) and not Horas1Sig(3)
	       and not Horas2Sig(0) and not Horas2Sig(1) and not Horas2Sig(2)  and not Horas2Sig(3)  
			 and not minutos1Sig(0) and not minutos1Sig(1) and not minutos1Sig(2) and not minutos1Sig(3)
			 and not minutos2Sig (0) and not minutos2Sig (1) and not minutos2Sig (2) and not minutos2Sig (3);
